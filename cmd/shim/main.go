...
func main() {
	...
	server := &http.Server{
		...
		Handler: httpapi.NewRouter(httpapi.RouterDeps{
			...
			Evidence:                  httpapi.EvidenceConfig{Enabled: cfg.ShimEvidenceEnabled, Root: cfg.ShimEvidenceRoot, MaxEntries: cfg.ShimEvidenceMaxEntries, StaleAfter: cfg.ShimEvidenceStaleAfter},
			...
			ServiceLimits: httpapi.ServiceLimits{
				...
				ChatCompletionsShadowStoreTimeout: cfg.ChatCompletionsShadowStoreTimeout,
				ResponsesProxyBufferBytes:         cfg.ResponsesProxyBufferMaxBytes,
			...
			ResponsesUpstreamTransport:               cfg.ResponsesUpstreamTransport,
	...
	logger.Info(
		...
		"shim_evidence_root", cfg.ShimEvidenceRoot,
		"shim_evidence_max_entries", cfg.ShimEvidenceMaxEntries,
		"shim_evidence_stale_after", cfg.ShimEvidenceStaleAfter,
		...
		"responses_upstream_transport", cfg.ResponsesUpstreamTransport,

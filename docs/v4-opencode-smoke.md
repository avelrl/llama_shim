...
| `gpu/gpt-oss-120b` | `.tmp/v4-opencode-smoke/gpu-gpt-oss-120b_20260520T231135Z` | Passed | Real OpenCode client completed the Go bugfix workflow; keep as Chat/OpenCode evidence, not Codex promotion. |
